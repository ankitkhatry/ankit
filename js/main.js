document.addEventListener('DOMContentLoaded', function() {
    ...
    const projectsData = {
        ...
        "5": {
            ...
            description: "A calculator for National Examination Board (NEB) students to calculate their GPA based on their marks. This tool helps students quickly determine their grade point average.",
            technologies: ["HTML", "CSS", "JavaScript"],
            features: ["GPA Calculation", "Grade Conversion", "User-friendly Interface", "Responsive Design"],
            image: "images/neb.jpg",
            link: "https://neb.ankitak.com.np/"
        },
        "6": {
            title: "NIST Website",
            description: "A responsive website for National Institute of Science and Technology (NIST) showcasing their programs, facilities, and admission information.",
            technologies: ["HTML", "CSS", "JavaScript"],
            features: ["Responsive Design", "Program Information", "Gallery Section", "Contact Form"],
            image: "images/nist.png",
            link: "https://ankitkhatry.github.io/nist/"
        }
    };
